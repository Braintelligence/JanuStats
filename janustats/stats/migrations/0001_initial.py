# Generated by Django 2.0.8 on 2018-08-28 13:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.CharField(blank=True, help_text='Land des Datums, maximal 100 Zeichen.', max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='StatValue',
            fields=[
                ...
                ('statobject', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='stats.StatData')),
            ],
        ),
    ]
